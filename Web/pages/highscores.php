				...
				<div class="skill">
					<ul>
						<?php foreach ($skill_array as $skill) { ?>
							<li><a href="<?php echo $script_directory; ?>highscores.php/<?php print $skill;?>"><img src="<?php echo $script_directory; ?>css/images/skill_icons/<?php print $skill;?>-lg.png" alt="<?php print $skill;?>"/><?php print ucwords(preg_replace("/[^A-Za-z0-9 ]/"," ",$skill));?></a></li>
						<?php } ?>
					</ul>
				</div>
			</article>
