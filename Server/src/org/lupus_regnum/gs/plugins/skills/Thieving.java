...
//import java.util.Arrays; // I think this one is too specific. Need to test.
import java.util.*;
...
// Below are imports with above imports removed from Latifundio's implementation for DarkQuest.
import org.lupus_regnum.gs.external.GameObjectDef;
import org.lupus_regnum.gs.model.GameObject;
import org.lupus_regnum.gs.external.NPCDef;
import org.lupus_regnum.gs.external.ItemDropDef;
                            ...
                            public void action(){
                                ...
                                world.getDelayedEventHandler().add(new MiniEvent(player, 1200){
                                    public void action(){
                                        ...
                                        owner.incExp(17, Chests[ourChest][2], true);
            ...
            world.getDelayedEventHandler().add(new ShortEvent(player) {
                public void action() {
                    ...
                    if (!chanceFormulae(Stalls[curStall][0])) {
                        ...
                        owner.getActionSender().sendInventory();
                        owner.incExp(17, Stalls[curStall][2], true);
                        owner.getActionSender().sendStat(17);
            ...
            world.getDelayedEventHandler().add(new ShortEvent(player) {
                public void action() {
                    if(!chanceFormulae(Doors[curDoor][4])) {
                        ...
                        doDoor();
                        owner.incExp(17, Doors[curDoor][5], true);
                        owner.getActionSender().sendStat(17);
                        owner.setSpam(false);
                        owner.setBusy(false);
