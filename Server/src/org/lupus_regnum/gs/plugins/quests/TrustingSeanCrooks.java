...
public class TrustingSeanCrooks extends Quest implements 
	...
	p.getActionSender().sendMenu(options);
		...
		p.setBusy(true);
		n.setBusy(true);
		p.informOfNpcMessage(new ChatMessage(p, "Hello, are you TinTin?", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(n, "Chea, wuts it 2 u?", p));
		sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "Your pal, Sean Crooks, asked me to tell you he was ready", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "to have the gang war begin and stated that you and I", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "would start the fight and then he and the others", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "would join once they heard the commotion.", n));
                sleep(3000);
		...
		sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "I agree. I am not sure about this whole ordeal myself.", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "It seems like we are about to poke a tiger.", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(n, "Yeah but hes my friend and I trust him with my life.", p));
		sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "Okay, so are you ready to go?", n));
                sleep(3000);
                p.informOfNpcMessage(new ChatMessage(n, "I will meet you there. I have some unfinished business here first.", p));
		sleep(3000);
                p.informOfNpcMessage(new ChatMessage(p, "Goodbye", n));
                p.setBusy(false);
		n.setBusy(false);
		sleep(1500);
