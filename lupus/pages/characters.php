...
$character_result = $connector->query("SELECT ".$skills.",rsca2_players.* FROM rsca2_experience LEFT JOIN rsca2_players ON rsca2_experience.user = rsca2_players.user WHERE rsca2_players.username = '$subpage'");
...
?>
				...
				<div id="stats">
					...
					<div id="sm-skill">
						...
						?>
						<span class="sm-skill"><a href="<?php echo $script_directory; ?>highscores/<?php echo $skill; ?>"><img src="/lupus/css/images/skill_icons/skill_<?php echo $skill; ?>.gif" alt="<?php echo $skill; ?>"/></a><?php echo experienceToLevel($character['exp_'.$skillc]); ?></span>
						<?php } ?>
					</div>
					<div id="sm-stats">
