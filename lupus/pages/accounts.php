...
if($user->data['is_registered']) {
	...
	$characters_result = $connector->query("SELECT * 
											FROM rsca2_players
											WHERE phpbb_id=$phpbb_user_id");
?>
	<div class="main">
		<div class="content">
			<article>	
				...
				<?php if(mysql_num_rows($characters_result) > 0){ ?>
					...
					<script type="text/javascript" language="JavaScript">
						$(document).ready(function() {
							$.post("/lupus/js/account.php", {username: '<?php echo $username; ?>', userenc: '<?php echo $user; ?>', owner: '<?php echo $id; ?>', hair: <?php echo $hc; ?>, head: <?php echo $hsprite; ?>, skin: <?php echo $sc; ?>, top: <?php echo $tc; ?>, gen: <?php echo $gender; ?>, pants: <?php echo $pc; ?>, combat: <?php echo $combat; ?>, online: <?php echo $online; ?>} ,function(data) {
