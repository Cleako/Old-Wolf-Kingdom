<?php
	...
	function drawCharacter($hc, $hsprite, $sc, $tc, $gender, $pc){
		...
		$gender = ($gender == 1) ? 0 : 1;
		return '<img src="/lupus/css/images/character/heads/c'.$hc.'t'.$hsprite.'sc'.$sc.'.png" id="head" alt="head" />
				<img src="/lupus/css/images/character/bodies/c'.$tc.'sc'.$sc.'t'.$gender.'.png" id="body" alt="body" />
				<img src="/lupus/css/images/character/legs/c'.$pc.'.png" id="leg" alt="leg" />';
	}
