package org.wolf_kingdom.client.util;
...
public class Config {
	public static String SERVER_IP = "localhost", CONF_DIR = System.getProperty("user.home") + File.separator + "WK", MEDIA_DIR = System.getProperty("user.home") + File.separator + "WK";
